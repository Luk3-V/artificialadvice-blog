<x-layout>
    <x-admin-layout>
        <main class="w-full bg-gray-100 border border-gray-200 p-6 rounded-xl">
            <h1 class="mb-6 text-center font-bold text-xl">Manage Writers</h1>
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right whitespace-nowrap">
                                    <div class="flex space-x-6">
                                        <a href="/admin/writers/{{ $writer->slug }}/edit" class="text-blue-500 hover:text-blue-700 font-bold">
                                            EDIT
                                        </a>
                                        <form action="/admin/writers/{{ $writer->slug }}" method="post">
                                            @csrf
                                            @method('DELETE')

        ...
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <div class="mt-8 md:mt-0">
                @guest
                    ...
                    <a href="/signin" class="ml-6 text-xs font-bold uppercase">
                        Sign In
                    </a>
                @else
                    @admin
                        <a href="/admin/posts" class="mr-6 text-xs font-bold uppercase">
                            Admin
                        </a>
                    @endadmin
                    ...
                    <form class="inline-flex" method="POST" action="/signout">
                        ...
                        <button type="submit" class="text-xs font-bold uppercase">
                            Sign Out
                        </button>
                    </form>   
                @endguest
